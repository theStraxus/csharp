namespace SdetBootcampDay2.TestObjects.Exercises
{
    public class OrderHandler
    {
         ...
         */
        public void Order(OrderItem item, int quantity)    /** changing from bool to void, no longer returning anything */
        {
            ...
            /** Removing this because we are de-coupling the payment processor from the order
        ...
        /**
        * Adding PayFor since we de-coupled from OrderAndPay
        */
